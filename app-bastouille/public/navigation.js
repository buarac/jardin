console.log("📦 navigation.js bien exécuté");
App = window.App || {};
    ...
    function registerMenu(config) {
        ...
        var menu = {
            ...
            getItems: function getItems() {
                //console.log(domEl.querySelectorAll('[data-list-item]'));
        ...
        function changeToPreviousMenu() {
            console.log("changeToPreviousMenu");
            if (menu.previousMenu && !Menus[menu.previousMenu].getItems().length) {
                console.log("cas: menu.previousMenu && !Menus[menu.previousMenu].getItems().length");
                return;
            }
