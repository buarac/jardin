...
export const FooterNav: React.FC = () => {
  ...
  const baseClasses = "flex flex-col items-center justify-center flex-1 py-2 gap-1";
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-10 border-t border-skin-muted bg-skin-card flex md:justify-around">
      ...
      <Link
        href="/cultures"
        className={`${baseClasses} hidden md:flex ${isActive("/cultures") ? activeClasses : inactiveClasses}`}
      >
        {/* Plant icon */}
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      ...
      <Link
        href="/recoltes/new"
        className={`${baseClasses} md:hidden ${isActive("/recoltes/new") ? activeClasses : inactiveClasses}`}
      >
        {/* Plus circle icon */}
      ...
      <Link
        href="/recoltes"
        className={`${baseClasses} hidden md:flex ${isActive("/recoltes") ? activeClasses : inactiveClasses}`}
      >
        {/* Basket icon */}
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      ...
      <Link
        href="/stats"
        className={`${baseClasses} ${isActive("/stats") ? activeClasses : inactiveClasses}`}
      >
        {/* Chart icon */}
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
